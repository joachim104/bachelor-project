...
class UserService {
    constructor(http, router) {
        ...
        this.baseUrl = 'https://api.quest.hololink.io';
    }
    createUser(username) {
        return this.http
